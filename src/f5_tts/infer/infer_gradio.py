...
@gpu_decorator
def infer(
    gen_text, model, remove_silence, cross_fade_duration=0.15, speed=1,ref_voice = "Theo", show_info=gr.Info
):
    ...
    voices = {
        ...
        "Eli": ("voices/eli.mp3", "Hola Ándres, te habla Eli de DeudU. Traigo opciones de pago para ti el valor total de tu deuda es de cincuenta millones de pesos. Tienes un descuento habilitado sólo por ¡hoy!.")
    }
